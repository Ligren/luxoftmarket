...
//    @PreAuthorize("isAuthenticated()")
    ...
    public String addGood(@ModelAttribute("good") Good good, BindingResult bindingResult) { //будет добавл€ть новую книгу в базу данных, добавили Binding Result который будет хранить в себе ошибки

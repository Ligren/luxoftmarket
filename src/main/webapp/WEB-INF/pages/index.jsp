...
<t:template>
  ...
  <body>
  Уважаемые проверяющие, я понимаю что всяинформация по пользователям (ник, ФИО, пароли и прочая информация) должна хранится в базе данных. Но так как
  у нас база данных in memory, то постоянно хранить в ней информацию возможности нет. Поэтому вся информация по пользователям зашита наглухо:
  ...
  Мы занимаемся тем что продаем прекрасные тапки для Всех, но наши тапки могут покупать только зарегистрированные пользователи. Зарегистрируйтеь пожалуйста.
  Мы занимаемся тем что продаем прекрасные тапки для Всех, но наши тапки могут покупать только зарегистрированные пользователи. Зарегистрируйтеь пожалуйста.
  Мы занимаемся тем что продаем прекрасные тапки для Всех, но наши тапки могут покупать только зарегистрированные пользователи. Зарегистрируйтеь пожалуйста.
  Мы занимаемся тем что продаем прекрасные тапки для Всех, но наши тапки могут покупать только зарегистрированные пользователи. Зарегистрируйтеь пожалуйста.
  </body>
